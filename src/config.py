...
cat_cols_like = ['flag', '^genre','Market_Name', 'taa_quintile', 'segment']
target = ['pop_all']
id_cols = ['mediabase_id', 'station_id', 'week_dt', 'breakout_id', 'demo_category', 'pop_co', 'pop_omt','gcr','gcr_adj']

exclude_cols_like = ['date']#,'_unv']#,'univ_spins', 'market_spins']
...
spins_filter_format = {'H1':150, 'C1':150, 'default':100}
model_version = None
...
breakout_map = {'*Core*': 'Core', '*Old*': 'Old', '*Young*': 'Young', 'Total': 'Total', 'White': 'White',
                ...
                'F (18-24)': 'Female (18-24)', 'F (20-29)': 'Female', 'F (25-34)': 'Female',
                'F (Other)': 'Female-Other'}
